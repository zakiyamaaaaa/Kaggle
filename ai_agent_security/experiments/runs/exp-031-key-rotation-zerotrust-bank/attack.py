...
def _build_attack_bank() -> tuple[tuple[str, ...], ...]:
    ...
    candidates.extend(_build_vault_http_candidates())
    candidates.extend(_build_legal_hold_http_candidates())
    candidates.extend(_build_key_rotation_http_candidates())
    candidates.extend(_build_zero_trust_http_candidates())
    candidates.extend(_build_dlp_scan_http_candidates())
    candidates.extend(_build_break_glass_http_candidates())
    ...
    candidates.extend(_build_seal_read_candidates())
    candidates.extend(_build_custody_read_candidates())
    candidates.extend(_build_key_rotation_read_candidates())
    candidates.extend(_build_zero_trust_read_candidates())
    candidates.extend(
        _build_three_turn_candidates(
            READ_ENCODE_SETUPS,
            TRANSFORM_STEPS,
