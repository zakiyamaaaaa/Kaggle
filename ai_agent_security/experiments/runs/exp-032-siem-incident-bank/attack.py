...
def _build_attack_bank() -> tuple[tuple[str, ...], ...]:
    ...
    candidates.extend(_build_siem_http_candidates())
    candidates.extend(_build_incident_http_candidates())
    candidates.extend(_build_jit_http_candidates())
    candidates.extend(_build_sso_http_candidates())
    ...
    candidates.extend(_build_siem_read_candidates())
    candidates.extend(_build_incident_read_candidates())
    candidates.extend(
        _build_three_turn_candidates(
            READ_ENCODE_SETUPS,
            TRANSFORM_STEPS,
