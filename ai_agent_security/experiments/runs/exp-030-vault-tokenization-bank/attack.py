...
def _build_attack_bank() -> tuple[tuple[str, ...], ...]:
    ...
    candidates.extend(_build_watermark_http_candidates())
    candidates.extend(_build_reconciliation_http_candidates())
    candidates.extend(_build_vault_http_candidates())
    candidates.extend(_build_legal_hold_http_candidates())
    candidates.extend(_build_integrity_http_candidates())
    candidates.extend(_build_portability_http_candidates())
    ...
    candidates.extend(_build_vault_read_candidates())
    candidates.extend(_build_legal_hold_read_candidates())
    candidates.extend(
        _build_three_turn_candidates(
            READ_ENCODE_SETUPS,
            TRANSFORM_STEPS,
