...
コンペ終了後の最終結果、private leaderboard、提出選択、技術・検証・運用の反省は[`postmortem-2026-08-08.md`](postmortem-2026-08-08.md)にまとめた。
...
- 締切は2026-08-05 23:59 UTC（JST 2026-08-06 08:59）で、残りは約3日11時間。採点待ちが
  ...
  一変更だけの比較へ実験枠を集中する。
- `kaggle-push/new-strategy-6213-repro/new-strategy-score-6-213.ipynb`を公開Notebookと再比較し、
